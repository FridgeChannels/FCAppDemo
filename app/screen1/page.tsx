...
export default function Screen1() {
  ...
  // Start TTS playback
  const startTTSPlayback = useCallback((text: string, startTime: number = 0) => {
  ...
  }, [ttsText, isPlayingTTS, ttsCurrentTime, ttsDuration, startTTSPlayback]);
  ...
  }, [currentIndex, articleSummaries, newsletterTitle, startTTSPlayback, handleNewsletterGenerate]);
